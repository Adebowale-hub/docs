...
<Accordion title="Real-Time Updates">
  - Only subscribe to data you're actively displaying - Unsubscribe when
  components unmount - Filter subscriptions to reduce bandwidth
</Accordion>
...
<Card
  ...
  icon="github"
  href="https://github.com/cocobase-team/examples"
>
